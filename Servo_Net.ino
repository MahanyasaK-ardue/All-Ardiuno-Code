      ...
      if (client.available()) {
        ...
        if (readString.length() < 100) {
         ...
         if (c == '\n') {          
           ...
           client.println("<TITLE>SERVO MOTOR I/O</TITLE>");
           client.println("<link rel = 'icon' href ='https://drive.google.com/file/d/1ajy6AZ8NOzyYfwcmqqz_s-Ny_JH1_K7b/view?usp=sharing' type = 'image/x-icon'>");
           client.println("</HEAD>");
           client.println("<BODY>");
           client.println("<H1>LED AND SERVO MOTOR IOT</H1>");
           client.println("<hr />");
           client.println("<br />");  
           ...
           client.println("<a href=\"/?button2off\"\">---+></a><br/><br><br><br><br><br><br><br><hr>"); 
           client.println("<p align='left'>   </p>");             
           client.println("<p align='left'>    Owned by MK</p>");  
